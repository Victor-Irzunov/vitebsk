...
const page = () => {
  return (
    <main className="sd:pt-48 xz:pt-48 pb-36 relative">
      <div className="w-full min-h-[90vh] bg-cover fon2 bg-center sd:block xz:hidden" />
      <div className="w-full min-h-[90vh] bg-cover fon2 bg-center sd:hidden xz:block -z-10" />
        ...
        <div className="container mx-auto text-white">
          ...
          <div className="mt-10 space-y-6">
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="https://" className="underline text-primary"> .by</a>.
            </p>
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="https://" className="underline text-primary"> https://by/</a>;
            </p>
            <p className="text-sm sm:text-base leading-7 text-gray-300">
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="https://gruzovoe-sto.by/" className="underline text-primary"> https://.by/</a>;
            </p>
            <p className="text-sm sm:text-base leading-7 text-gray-300">
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="https://gruzovoe-sto.by/" className="underline text-primary"> https://</a>, оказания услуг, обработки запросов и заявок от Пользователя.
            </p>
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="mailto:@gmail.com" className="underline text-primary"> ...@gmail.com</a>
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="mailto:info@" className="underline text-primary">info@</a>.
            </p>
            <p className="text-sm sm:text-base leading-7 text-gray-300">
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="https:///politika/" className="underline text-primary"> https:///politika/</a>.
            </p>
          </div>
